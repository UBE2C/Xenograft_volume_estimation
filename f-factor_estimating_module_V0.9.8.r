...
ks_gof_test = function(measurement_list, correction = TRUE) {
...
nonparametric_test = "numeric_outlier_test", model_prescision_test = "rmse", plot_qc_volume = "corrected", volume_correction = TRUE, correction_method = "linear_correction") {
    ...
    if (model_prescision_test == "rmse") {
        #Run the precision test on the estimated volumes
        rmse_result_estim <- rmse_test(unif_mData_corr_vols, correction = FALSE)

        #Run the precision test on the corrected volumes
        rmse_result_corr <- rmse_test(unif_mData_corr_vols, correction = TRUE)
    ...
    } else if (model_prescision_test == "mae") {
        #Run the precision test on the estimated volumes
        mae_result_estim <- mae_test(unif_mData_corr_vols, correction = FALSE)

        #Run the precision test on the corrected volumes
        mae_result_corr <- mae_test(unif_mData_corr_vols, correction = TRUE)
