        ...
        if (is_data_normal_output_list[[index]]$p.value < 0.05) {
            ...
            if (nonparam_test == "numeric_outlier_test") {
                for (e in seq_along(calculate_f_constants_output_list)) {
                    calculate_f_constants_output_list[[index]] <- remove_outlier_f_const_nonparam(calculate_f_constants_output_list[[index]])
                ...
                for (e in seq_along(calculate_f_constants_output_list)) {
                    calculate_f_constants_output_list[[index]] <- modified_Zscore_test(calculate_f_constants_output_list[[index]])
                    calculate_f_constants_output_list[[index]] <- modified_Zscore_test(calculate_f_constants_output_list[[index]], left_tail = FALSE)
            ...
            for (e in seq_along(calculate_f_constants_output_list)) {
                    calculate_f_constants_output_list[[index]] <- remove_outlier_f_const_param(calculate_f_constants_output_list[[index]])
                    calculate_f_constants_output_list[[index]] <- remove_outlier_f_const_param(calculate_f_constants_output_list[[index]], left_tail = FALSE)
